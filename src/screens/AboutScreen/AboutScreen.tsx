    ...
    return ( 
        <ScrollView style={styles.scrollView}>
            ...
            <View style={{ flexDirection: 'row'}}>
              <Image style={{ flex: 1, height: 200 }} resizeMode='contain' source={{uri: 'https://firebasestorage.googleapis.com/v0/b/enloe-charity-ball.appspot.com/o/banner-smol.jpg?alt=media&token=cb5d6e3b-c9cd-46c1-9eac-8d7f279144c8'}}/>
            </View>
